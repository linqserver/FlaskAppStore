...
CREATE TABLE `basket_table` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9009 DEFAULT CHARSET=latin1;
...
INSERT INTO `basket_table` VALUES (9002,4,1,'admin2'),(9003,5,3,'admin2'),(9008,6,1,'helloworld');
...
-- Dump completed on 2017-11-26  0:31:49
